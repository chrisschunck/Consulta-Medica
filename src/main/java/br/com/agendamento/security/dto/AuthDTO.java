...
public class AuthDTO {
    ...
    public record LoginRequest(
        @NotBlank(message = "Email e obrigatorio") @Email 
        @Schema(description="email para login do usuario", example="matheus.usuario@gmail.com", minLength= 15, maxLength= 50) String email,
    ...
    public record RegistroRequest(
        @NotBlank @Size(min = 3, max = 120) @Schema(description="nome completo do usuario", example="Matheus Henrique de Souza", minLength= 15, maxLength= 50) String nome,
        @NotBlank @Email 
        @Schema(description="email de contato", example="matheus.usuario@gmail.com", minLength= 15, maxLength= 50) String email,
