...
public class AuthDTO {
    ...
    public record LoginRequest(
        ...
        @Schema(description="email para login do usuario", example="matheus.usuario@gmail.com") String email,
    ...
    public record RegistroRequest(
        ...
        @NotBlank @Email 
        @Schema(description="email de contato", example="matheus.usuario@gmail.com") String email,
